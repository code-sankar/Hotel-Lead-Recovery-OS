...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn('rounded-card border border-ink-200 bg-white shadow-[0_1px_2px_rgba(16,24,40,0.04)]', className)}
      {...props}
    />
  );
}
...
export function CardFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn('flex items-center gap-2 border-t border-ink-200 px-5 py-3', className)} {...props} />
  );
}
